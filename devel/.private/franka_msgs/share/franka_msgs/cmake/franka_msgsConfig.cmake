...
if("TRUE" STREQUAL "TRUE")
  set(franka_msgs_SOURCE_PREFIX /workspace/src/franka_ros/franka_msgs)
  set(franka_msgs_DEVEL_PREFIX /workspace/devel/.private/franka_msgs)
  ...
  set(franka_msgs_INSTALL_PREFIX /workspace/install)
...
if(NOT "/workspace/devel/.private/franka_msgs/include " STREQUAL " ")
  set(franka_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/workspace/devel/.private/franka_msgs/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'franka_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/src/franka_ros/franka_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /workspace/devel/.private/franka_msgs/lib;/workspace/devel/lib;/opt/ros/noetic/lib)
