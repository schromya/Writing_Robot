...
if("TRUE" STREQUAL "TRUE")
  set(franka_example_controllers_SOURCE_PREFIX /workspace/src/franka_ros/franka_example_controllers)
  set(franka_example_controllers_DEVEL_PREFIX /workspace/devel/.private/franka_example_controllers)
  ...
  set(franka_example_controllers_INSTALL_PREFIX /workspace/install)
...
if(NOT "/workspace/devel/.private/franka_example_controllers/include;/workspace/src/franka_ros/franka_example_controllers/include;/usr/include " STREQUAL " ")
  set(franka_example_controllers_INCLUDE_DIRS "")
  set(_include_dirs "/workspace/devel/.private/franka_example_controllers/include;/workspace/src/franka_ros/franka_example_controllers/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'franka_example_controllers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/src/franka_ros/franka_example_controllers/${idir}'.  ${_report}")
    endif()
    _list_append_unique(franka_example_controllers_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "franka_example_controllers;/usr/lib/libfranka.so.0.9.2")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /workspace/devel/.private/franka_example_controllers/lib;/workspace/devel/lib;/opt/ros/noetic/lib)
