...
if("TRUE" STREQUAL "TRUE")
  set(relaxed_ik_ros1_SOURCE_PREFIX /workspace/src/relaxed_ik_ros1)
  set(relaxed_ik_ros1_DEVEL_PREFIX /workspace/devel/.private/relaxed_ik_ros1)
  ...
  set(relaxed_ik_ros1_INSTALL_PREFIX /workspace/install)
...
if(NOT "/workspace/devel/.private/relaxed_ik_ros1/include " STREQUAL " ")
  set(relaxed_ik_ros1_INCLUDE_DIRS "")
  set(_include_dirs "/workspace/devel/.private/relaxed_ik_ros1/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'relaxed_ik_ros1' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/src/relaxed_ik_ros1/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /workspace/devel/.private/relaxed_ik_ros1/lib;/workspace/devel/lib;/opt/ros/noetic/lib)
