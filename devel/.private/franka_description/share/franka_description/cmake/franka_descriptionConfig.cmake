...
if("TRUE" STREQUAL "TRUE")
  set(franka_description_SOURCE_PREFIX /workspace/src/franka_ros/franka_description)
  set(franka_description_DEVEL_PREFIX /workspace/devel/.private/franka_description)
  ...
  set(franka_description_INSTALL_PREFIX /workspace/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'franka_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/src/franka_ros/franka_description/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /workspace/devel/.private/franka_description/lib;/workspace/devel/lib;/opt/ros/noetic/lib)
