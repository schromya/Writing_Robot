...
if("TRUE" STREQUAL "TRUE")
  set(franka_gripper_SOURCE_PREFIX /workspace/src/franka_ros/franka_gripper)
  set(franka_gripper_DEVEL_PREFIX /workspace/devel/.private/franka_gripper)
  ...
  set(franka_gripper_INSTALL_PREFIX /workspace/install)
...
if(NOT "/workspace/devel/.private/franka_gripper/include;/workspace/src/franka_ros/franka_gripper/include;/usr/include " STREQUAL " ")
  set(franka_gripper_INCLUDE_DIRS "")
  set(_include_dirs "/workspace/devel/.private/franka_gripper/include;/workspace/src/franka_ros/franka_gripper/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'franka_gripper' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/src/franka_ros/franka_gripper/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /workspace/devel/.private/franka_gripper/lib;/workspace/devel/lib;/opt/ros/noetic/lib)
